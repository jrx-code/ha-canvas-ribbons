...
#
# Usage:
#   make publish     Full chain: main → lint/test → publish → full pipeline → github
...
GITLAB_PROJECT = jiwanus%2Fha-canvas-ribbons
POLL_INTERVAL = 10
...
publish:
	...
	echo "           (lint+test+security+build+wiki+github)"; \
	echo "══════════════════════════════════════════════════"; \
